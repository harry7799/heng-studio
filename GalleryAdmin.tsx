      ...
      <header className="sticky top-0 z-50 border-b border-white/10 bg-black/95 backdrop-blur-md">
        <div className="px-4 py-3 flex items-center justify-between flex-wrap gap-3">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            ...
            <a href="#/admin" className="px-3 py-1.5 rounded-full border border-white/15 hover:border-white/40 font-mono text-[10px] uppercase tracking-widest flex items-center gap-1">
